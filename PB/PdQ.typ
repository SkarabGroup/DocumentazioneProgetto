...
#figure(
  block(
    ...
    table(
      ...
      [Informativa su analisi già aggiornata; disponibilità immediata del report senza nuova analisi.],
      ...
      [Avviso di presa in carico mostrato e utente accodato al processo pendente.],
      ...
      [TU-41.1],
      [FROb220],
      [Verifica ordinamento elenco repository privati registrati in ordine decrescente.],
      ...
      [TU-42.3],
      [FROb225],
      [Verifica avvio procedura di rimozione di un repository dal catalogo privato.],
      [Caricamento corretto del dialog di rimozione.],
      ...
      [Username e/o email dell'utente visibili nella lista.],
      ...
      [TU-44.4],
      [FROb232],
      [Verifica predisposizione comando di conferma per aggiunta utente.],
      [Pulsante di conferma presente e funzionante.],

      [TU-44.5],
      [FROb233],
      [Verifica notifica errore sintattico per identificativo utente non valido.],
      [Messaggio di errore mostrato a schermo in caso di formato errato.],

      [TU-44.6],
      [FROb234],
      [Verifica inibizione form autorizzazione con identificativo vuoto.],
      [Procedura inibita e avviso mostrato in caso di campo vuoto.],
      ...
      [TU-45.2],
      [FROb236],
      [Verifica selezione utente e avvio procedura revoca da lista profili.],
      [Azione di revoca avviata per il profilo specifico selezionato.],
      ...
      [TU-46.2],
      [FROb238],
      [Verifica presenza dialog di conferma esplicita per eliminazione raccolta.],
      [Richiesta conferma mostrata prima dell'eliminazione definitiva.],

      [TU-46.3],
      [FROb239],
      [Verifica ripristino stato su annullamento rimozione raccolta.],
      [Procedura interrotta e raccolta mantenuta inalterata nel sistema.],
    ),
  ),
