...
#table(
  ...
  [#VRObx],
  [L'interfaccia web deve essere compatibile con sistema operativo Windows 10/11],
  [Decisione Interna],
  [#VRObx],
  ...
  [Decisione Interna],
  [#VRObx],
  [L'interfaccia web deve essere compatibile con browser Chrome 120+],
  [Decisione Interna],
  [#VRObx],
  [L'interfaccia web deve essere compatibile con browser Firefox 120+],
  [Decisione Interna],
  [#VRObx],
  [L'interfaccia web deve essere compatibile con browser Safari 17+],
  [Decisione Interna],
)