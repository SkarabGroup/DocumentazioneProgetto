...
Nel testo, *ogni termine contrassegnato dall'apice "G"* rimanda alla voce corrispondente del Glossario pubblicato sul sito ufficiale del gruppo, consentendo al lettore di accedere direttamente alla definizione associata.
...
- *Produzione, gestione e verifica della documentazione* \
  Redazione progressiva della documentazione di progetto secondo strutture e convenzioni condivise, gestione delle versioni dei documenti e verifica della loro completezza, coerenza e conformità alle #link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#norme-di-progetto")[#def[Norme di Progetto]] e agli standard di riferimento;
...
In occasione delle scadenze ufficiali, il #link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#responsabile")[#def[Responsabile di Progetto]] deve seguire questa checklist obbligatoria:
1. *Verifica di Conformità:* Accertarsi che tutti i documenti siano nello stato *Approved* e che ogni artefatto in rilascio (documentale o software) soddisfi i criteri di verifica specifici definiti per esso nel #link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#piano-di-qualifica")[#def[Piano di Qualifica]] ;
...
3. *Tagging:* Creare una *Release* sul repository #link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#github")[#def[GitHub]] con il tag di versione corrispondente (es. `v1.0.0-RTB`);
...
Il *#link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#piano-di-progetto")[#def[Piano di Progetto]]* costituisce il riferimento gestionale vincolante per la conduzione del progetto e deve definire, in modo tracciabile e verificabile:
...
- Monitoraggio e Controllo del Rendimento degli #link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#sprint")[#def[Sprint]].
...
Per le fasi successive del progetto, in particolare in prossimità della *#link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#product-baseline")[#def[Product Baseline]] (PB)*, la pianificazione adotta un livello di dettaglio più ampio e meno vincolante. In questa fase, la pianificazione si limita alla definizione delle macro-attività previste, evitando una scomposizione dettagliata in task operative.
...
La pianificazione a livello di Product Baseline garantisce comunque la tracciabilità delle principali attività attese, includendo, a titolo esemplificativo, l’analisi post *#link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#proof-of-concept")[#def[proof of concept]]*, la progettazione architetturale, la progettazione di dettaglio e le attività che convergono nello sviluppo del *#link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#minimum-viable-product")[#def[Minimum Viable Product]] (MVP)*.
...
+ Per la *Requirements and Technology Baseline (RTB)* tutte le attività pianificate risultano:
  ...
  - le attività pianificate in RTB risultano definite in modo atomico; 
  - eventuali dipendenze sono esplicitate e tracciate sullo strumento di issue tracking;
...
==== Definizione del Documento
Le *#link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#norme-di-progetto")[#def[Norme di Progetto]] (NdP)* costituiscono il documento normativo di riferimento che disciplina le modalità operative adottate dal gruppo di lavoro durante l’intero ciclo di vita del progetto.
...
I documenti di fornitura normati dalle presenti #link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#norme-di-progetto")[#def[Norme di Progetto]] sono:
- #link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#piano-di-progetto")[#def[Piano di Progetto]] (PdP);
- #link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#piano-di-qualifica")[#def[Piano di Qualifica]] (PdQ);
- #link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#analisi-dei-requisiti")[#def[Analisi dei Requisiti]] (AdR);
- #link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#norme-di-progetto")[#def[Norme di Progetto]] (NdP);
- #link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#glossario")[#def[Glossario]].
...
Gli artefatti prodotti dal Processo di Sviluppo normati dalle presenti #link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#norme-di-progetto")[#def[Norme di Progetto]] sono:
- Codice sorgente;
- Test.
...
Il Processo di Qualifica garantisce che il prodotto software e la documentazione soddisfino gli standard di qualità definiti attraverso le attività di #link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#verifica")[#def[Verifica]] e #link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#validazione")[#def[Validazione]].
...
- [ ] ogni documento è redatto in formato #link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#typst")[#def[Typst]] e archiviato nel repository del progetto;
...
- [ ] ogni documento è associato a task su #link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#jira")[#def[Jira]] per tracciabilità;
...
- [ ] tutte le attività di verifica e validazione sono documentate nel #link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#piano-di-qualifica")[#def[Piano di Qualifica]];
...
====== Processo di Formazione
Il Processo di Formazione garantisce che tutti i membri del team acquisiscano le competenze necessarie alle tecnologie adottate nel progetto _#link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#code-guardian")[#def[Code Guardian]]_.
...
- *Act:* aggiornamento delle #link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#norme-di-progetto")[#def[Norme di Progetto]] e ricalibrazione delle metriche per lo Sprint successivo.
...
- *Decisioni prese*;
- *Azioni da intraprendere*, con eventuale assegnatario e ore previste.
...
== Processo di Sviluppo
Il Processo di Sviluppo adottato da #link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#skarab-group")[#def[Skarab Group]] definisce le attività necessarie all'analisi dei requisiti, alla progettazione, alla codifica, al testing e all'accettazione del prodotto Software _#link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#code-guardian")[#def[Code Guardian]]_.
...
- rispondere rapidamente ai feedback della #link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#proponente")[#def[Proponente]] e agli apprendimenti derivanti dall'uso delle tecnologie;
- mantenere alta la qualità del prodotto grazie a continue attività di verifica;
- allineare lo sviluppo alle #link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#milestone")[#def[milestone]] #link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#requirements-and-technology-baseline")[#def[RTB]] e #link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#product-baseline")[#def[PB]] definite dal corso.
...
- *Definizione dei casi d'uso*: modellazione delle interazioni tra attori e sistema attraverso diagrammi #link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#unified-modeling-language")[#def[UML]] ;
...
- *#link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#analisi-dei-requisiti")[#def[Analisi dei Requisiti]]*: attività cardine della RTB;
- *#link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#proof-of-concept")[#def[Proof of Concept]] (PoC)*: dimostrazione pratica della fattibilità tecnica delle soluzioni progettate;
- *Definizione degli Standard*: consolidamento delle norme di codifica, delle convenzioni e degli strumenti di sviluppo documentati nelle presenti #link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#norme-di-progetto")[#def[Norme di Progetto]].
...
- *#link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#typst")[#def[TypeScript]]*: utilizzato per il frontend con #link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#react")[#def[React]] e per il backend con #link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#nestjs")[#def[NestJS]];
- *#link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#python")[#def[Python]]*: impiegato per la logica degli #link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#agente")[#def[Agenti]], l'Orchestratore e gli script di analisi dati;
...
*Nota di avanzamento*: si prevede che questa sezione venga approfondita ed estesa durante la fase di sviluppo verso la _Product Baseline_ (PB), per includere specificità tecniche necessarie al completamento del _#link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#minimum-viable-product")[#def[Minimum Viable Product]]_.
...
documenti ufficiali del progetto _#link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#code-guardian")[#def[Code Guardian]]_.

=== Ciclo di Vita dei Documenti
Ogni documento segue obbligatoriamente il seguente ciclo di vita:

+ *Creazione / Modifica*: redazione o aggiornamento del contenuto in formato sorgente (#link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#typst")[#def[Typst]]). L'attività deve essere tracciata da una #link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#task")[#def[task]] su #link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#jira")[#def[Jira]] ;
...
- *#link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#tinymist")[#def[Tinymist]]*: estensione per #link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#vs-code")[#def[VS Code]] che fornisce anteprima in tempo reale e supporto per la scrittura in Typst.
...
== Qualifica
Il processo di *Qualifica* garantisce che il prodotto software e la documentazione soddisfino gli standard di qualità definiti e i requisiti specificati. Tale processo si articola nelle attività di _#link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#verifica")[#def[Verifica]]_ e _#link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#validazione")[#def[Validazione]]_, complementari ma distinte negli obiettivi.
...
#link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#skarab-group")[#def[Skarab Group]] identifica i seguenti obiettivi per il processo di Verifica:

- garantire che ogni artefatto prodotto sia conforme alle #link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#norme-di-progetto")[#def[Norme di Progetto]];
...
Questa sezione verrà ampliata durante lo svolgimento della _#link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#product-baseline")[#def[Product Baseline]]_ (PB).

Per il calcolo dell'indice di #link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#gulpease")[#def[Gulpease]] è stato utilizzato il servizio #link("https://farfalla-project.org/readability_static/")[#underline[farfalla-project.org/readability_static/]].

==== Attività proposte
In conformità allo standard ISO/IEC/IEEE 12207, il processo di Verifica si articola nelle seguenti attività:
...
==== Implementazione del processo
Skarab Group ha stabilito che la principale necessità del progetto _#link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#code-guardian")[#def[Code Guardian]]_ è assicurare che il prodotto soddisfi le esigenze di #link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#var-group")[#def[Var Group]] attraverso verifiche sistematiche e rigorose.
...
Le verifiche sono condotte attraverso il meccanismo delle _Pull Request_ su #link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#github")[#def[GitHub]], che garantisce:
- tracciabilità delle modifiche;
- revisione da parte di un #link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#verificatori")[#def[Verificatore]] diverso dal redattore;
...
- *Metodi di Lettura:* si suddividono in:
...
- *Strumenti automatici di linting*:
  - #link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#eslint")[#def[ESLint]] per codice JavaScript/TypeScript;
...
======= Test di Sistema
I Test di Sistema valutano il comportamento del sistema nel suo complesso, verificandone la conformità ai requisiti definiti nell'#link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#analisi-dei-requisiti")[#def[Analisi dei Requisiti]].
...
=== Validazione
Il processo di Validazione ha come scopo verificare che il prodotto _#link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#code-guardian")[#def[Code Guardian]]_ soddisfi le esigenze di #link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#var-group")[#def[Var Group]] e degli utenti finali, garantendo che il sistema realizzato sia effettivamente quello richiesto.

Mentre la Verifica si concentra sulla conformità tecnica delle specifiche, la Validazione si focalizza sulla conformità del prodotto alle aspettative e ai bisogni reali degli _#link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#stakeholder")[#def[stakeholder]]_.
...
#figure(
  table(
    ...
    [Coordina e supervisiona l'intero progetto garantendo il rispetto delle scadenze e del budget.
      Rappresenta Skarab Group nei rapporti con #link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#var-group")[#def[Var Group]], con i docenti Prof. Cardin e Prof. Vardanega
      e con gli altri stakeholder esterni. Pianifica le attività su #link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#jira")[#def[Jira]], assegna le risorse ai membri del
    ...
    [Gestisce l'infrastruttura tecnica e organizzativa del progetto. Configura e mantiene gli strumenti
      di versionamento (#link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#git")[#def[Git]]/#link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#github")[#def[GitHub]]), il sistema di issue tracking (#link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#jira")[#def[Jira]]) e gli ambienti di sviluppo. Definisce il workflow di branching e le convenzioni di commit. Gestisce i template di documento, redige e mantiene aggiornate le #link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#norme-di-progetto")[#def[Norme di Progetto]]. Garantisce backup e sicurezza dei dati e risolve tempestivamente
    ...
    [Assicura la qualità degli artefatti prodotti attraverso attività di verifica sistematica. Controlla
      ...
      Pull Request su #link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#github")[#def[GitHub]], segnala non conformità e propone azioni correttive. Monitora le metriche di qualità.],
...
La gestione dell'infrastruttura è di competenza dell'#link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#amministratore")[#def[Amministratore]] di Progetto.
...
#figure(
  table(
    ...
    [Hosting remoto dei #link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#repository")[#def[repository]] Git. Utilizzato per la sincronizzazione del lavoro tra i membri, la gestione delle Pull Request, la code review e le issue.],
    ...
    [Script sviluppati internamente per automatizzare attività ripetitive: generazione del Glossario (formati PDF e HTML), compilazione dei documenti #link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#typst")[#def[Typst]], aggiornamento del sito web del gruppo.],
  ),
...
Il branch `develop` è protetto e richiede Pull Request approvata da un #link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#verificatore")[#def[Verificatore]] diverso dal redattore prima di qualsiasi integrazione.
...
== Processo di Miglioramento
Il processo di miglioramento è fondamentale per garantire che i prodotti del progetto soddisfino gli standard di qualità definiti e le aspettative degli #link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#stakeholder")[#def[stakeholder]].

=== Attività Previste
Il processo si articola in tre fasi:

+ *Inizializzazione*: definizione dei processi organizzativi che guidano il lavoro del team, documentati nelle presenti #link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#norme-di-progetto")[#def[Norme di Progetto]] ;
+ *Valutazione*: monitoraggio continuo dei processi attraverso le metriche definite nel _#link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#piano-di-qualifica")[#def[Piano di Qualifica]]_. La valutazione avviene con cadenza di Sprint durante la retrospettiva;
...
#figure(
  table(
    ...
    [#link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#nestjs")[#def[NestJS]]], [Documentazione ufficiale NestJS; guide e tutorial specifici sul framework.],
    ...
    [Documentazione ufficiale Python; documentazione dei framework per #link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#agente")[#def[agenti]] AI; documentazione #link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#amazon-web-service")[#def[AWS]] Bedrock/OpenAI per LLM.],
    ...
    [#link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#typst")[#def[Typst]]], [Documentazione ufficiale Typst; template e funzioni del #link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#repository")[#def[repository]] interno.],
    ...
    [AWS], [Documentazione ufficiale #link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#amazon-web-service")[#def[AWS]]; materiale fornito da Var Group durante le sessioni di formazione.],
  ),
...
Nel corso degli #link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#sprint")[#def[Sprint]], i membri del team potranno dedicare tempo alla formazione personale nelle fasi di attività a peso minore, senza che ciò comprometta il rispetto degli
obiettivi di Sprint. Il #link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#responsabile")[#def[Responsabile di Progetto]] può, qualora lo ritenga necessario, pianificare periodi dedicati esplicitamente all'approfondimento tecnologico, specialmente
in preparazione alle fasi di progettazione e sviluppo verso la _#link("https://skarabgroup.github.io/DocumentazioneProgetto/Glossario/glossario.html#product-baseline")[#def[Product Baseline]]_ (PB).
