...
#figure(
  table(
    ...
    [*Descrizione*], 
    [Sussiste il rischio che i criteri di valutazione implementati negli agenti producano risultati imprecisi. Ciò potrebbe tradursi in *falsi positivi* o, più gravemente, in *falsi negativi*. Inoltre, il sistema potrebbe valutare come corretta una remediation che in realtà introduce nuovi bug. Questi errori potrebbero compromettere l'affidabilità del sistema e la fiducia degli utenti nel prodotto finale.],
    [*Mitigazione*], 
...
#figure(
  table(
    ...
    [*Descrizione*], 
    [Dato che i membri del team hanno stili di scrittura diversi, i documenti (#def[Piano di Progetto], *Norme di Progetto*, ecc.) potrebbero risultare frammentati, poco coerenti o con terminologie discordanti. Questo potrebbe compromettere la chiarezza e la professionalità della documentazione consegnata.],
    [*Mitigazione*], 
